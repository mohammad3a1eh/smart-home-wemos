...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.channel_box.setTitle(_translate("MainWindow", "Channel manager"))
        self.channel_1.setText(_translate("MainWindow", "Channel One"))
        self.channel_2.setText(_translate("MainWindow", "Channel Two"))
        self.channel_3.setText(_translate("MainWindow", "Channel Three"))
        self.channel_4.setText(_translate("MainWindow", "Channel Four"))
        self.option_box.setTitle(_translate("MainWindow", "Device options"))
        self.ip.setText(_translate("MainWindow", "192.168.4.1"))
        self.ip.setPlaceholderText(_translate("MainWindow", "Device ip"))
        self.auto_refresh.setText(_translate("MainWindow", "Auto refresh every "))
        self.delay.setText(_translate("MainWindow", "5"))
        self.delay.setPlaceholderText(_translate("MainWindow", "0"))
        self.label.setText(_translate("MainWindow", "seconds"))
        self.refresh.setText(_translate("MainWindow", "Manual refresh"))
        self.webpanel.setText(_translate("MainWindow", "Open web-panel"))
        self.log_box.setTitle(_translate("MainWindow", "Log"))
        self.log.setPlainText(_translate("MainWindow", "{\n"
"    \"channel\": \"asd\"\n"
"}"))
        self.tip_box.setTitle(_translate("MainWindow", "Tips"))
        self.tips.setText(_translate("MainWindow", "Connect to the board and enter the iPanel.\n"
...
"If the connection was established, you can do the control (:"))
        self.rgb_box.setTitle(_translate("MainWindow", "RGB controller"))
        self.set_color.setText(_translate("MainWindow", "Set color"))
        self.select_color.setText(_translate("MainWindow", "Select color"))
        self.preview_color.setText(_translate("MainWindow", "preview"))
        self.temp_box.setTitle(_translate("MainWindow", "temperature"))
